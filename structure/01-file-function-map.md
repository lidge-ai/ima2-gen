...
| Store | `ui/src/store/useAppStore.ts` | 696 | Zustand facade; classic/node/video/multimode/inflight/history/asset-gen logic split into `ui/src/store/store*Impl.ts` modules |
