...
| `lib/nodeTemplateThoiTrang.ts` | 656 | Fashion concept template library: one outfit in, models wearing it per concept |
...
| Store | `ui/src/store/useAppStore.ts` | 708 | Zustand facade; classic/node/video/multimode/inflight/history/asset-gen logic split into `ui/src/store/store*Impl.ts` modules |
